...
<div class="sixteen centered wide column row">
	...
	<table class="ui teal selectable stackable table">
		...
		<tr>
			...
			<td><?php echo date('d/m/Y', strtotime($equipamento->dataDeCompra)); ?></td>
		</tr>
...
<?php if($userAuth['role'] !== 'Administrador' && $userAuth['role'] !== 'Suporte' && !UsersController::isCoordenador($userAuth, $equipamento->local->codigo) && !UsersController::isBolsista($userAuth, $equipamento->local->codigo)): ?>
