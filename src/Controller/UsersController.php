...
class UsersController extends AppController {
    ...
    public function view($matricula = null) {
        ...
        $user = $this->Users 
                        ...
                        ->contain([
                                    'UserLocals', 
                                    'Equipamentos' => ['TipoEquipamentos', 'Locals']
                                ])
                        ->first();
        ...
        $currentUser = $this->Users
                                ->find()
                                ->where(['matricula' => $this->request->session()->read('Auth.User.matricula') ])
                                ->contain(['UserLocals'])
                                ->first();
    ...
    public function login(){
        ...
        if($this->request->is('post')){
            ...
            if($user){
                ...
                date_default_timezone_set("America/Fortaleza");
                $u = $this->Users->get($user['id'], ['contain' => ['UserLocals']]);
    ...
    public function isAuthorized($user){
        ...
        if($this->request->action === 'view'){
            ...
            if(isset($user['role']) && $user['role'] === 'Administrador' || $user['matricula'] === $userMatricula || $userView->role === 'Bolsista'){
                return true;
            }
