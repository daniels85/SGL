<?php 
	...
	class MYPDF extends TCPDF {
	    ...
	    public function tabelaEquipamentos($header,$data) {
	        ...
	        $this->Ln();
	        $this->SetFont('', 'B', 9);
	        $this->Cell( 15, 6, "Nome:", 'LTB', 0, 'L', 0);
	        $this->SetFont('', '', 9);
	        $this->Cell( 55, 6, $data->nome, 'RTB', 0, 'C', 0);
	        $this->SetFont('', 'B', 9);
	        $this->Cell( 15, 6, "Tombo:", 'LTB', 0, 'L', 0);
	        $this->SetFont('', '', 9);
	        $this->Cell( 45, 6, $data->tombo, 'RTB', 0, 'C', 0);
	        $this->SetFont('', 'B', 9);
			$this->Cell( 15, 6, "Status:", 'LTB', 0, 'L', 0);
			$this->SetFont('', '', 9);
	        $this->Cell( 35, 6, $data->status, 'RTB', 0, 'C', 0);
	        $this->SetFont('', 'B', 9);
	        $this->Ln();
	        $this->Cell( 15, 6, "Tipo:", 'LTB', 0, 'L', 0);
			$this->SetFont('', '', 9);
	        $this->Cell( 45, 6, $data->tipo_equipamento->nome, 'RTB', 0, 'C', 0);
	        $this->SetFont('', 'B', 9);
	        $this->Cell( 15, 6, "Fornecedor:", 'LTB', 0, 'L', 0);
			$this->SetFont('', '', 9);
	        $this->Cell( 45, 6, $data->fornecedor, 'RTB', 0, 'C', 0);
	        $this->SetFont('', 'B', 9);
	        $this->SetFont('', 'B', 9);
	        $this->Cell( 15, 6, "Modelo:", 'LTB', 0, 'L', 0);
			$this->SetFont('', '', 9);
	        $this->Cell( 45, 6, $data->modelo, 'RTB', 0, 'C', 0);
	        $this->SetFont('', 'B', 9);
	        $this->Ln();
	    ...
	    public function relatorioEquipamento($equipamento, $dataInicio, $dataFim){
	    	...
	    	$this->Ln();
	    	$this->SetFont('', 'B', 9);
	    	$this->Cell(15, 5, "Nome:", 'LTB', 0, 'L', 0);
	    	$this->SetFont('', '', 9);
	    	$this->Cell(55, 5, $equipamento->nome, 'TBR', 0, 'C', 0);
	    	$this->SetFont('', 'B', 9);	
	    	$this->Cell(15, 5, "Tombo:", 'LTB', 0, 'L', 0);
	    	$this->SetFont('', '', 9);
	    	$this->Cell(45, 5, $equipamento->tombo, 'TBR', 0, 'C', 0);
	    	$this->SetFont('', 'B', 9);
	    	$this->Cell(15, 5, "Status:", 'LTB', 0, 'L', 0);
	    	$this->SetFont('', '', 9);
	    	$this->Cell(35, 5, $equipamento->status, 'TBR', 0, 'C', 0);	

			$this->Ln();	
			$this->SetFont('', 'B', 9);
	    	$this->Cell(15, 5, "Local:", 'LTB', 0, 'L', 0);	
	    	$this->SetFont('', '', 9);	    	
	    	$this->Cell(75, 5, $equipamento->local->nome, 'TBR', 0, 'C', 0);
	    	$this->SetFont('', 'B', 9);
			$this->Cell(15, 5, "Responsável:", 'LTB', 0, 'L', 0);	
			$this->SetFont('', '', 9);	    	
	    	$this->Cell(75, 5, $equipamento->user->nome, 'TBR', 0, 'C', 0);		
			
			$this->Ln();

			$this->SetFont('', 'B', 9);
			$this->Cell(15, 5, "Tipo:", 'LTB', 0, 'L', 0);	
			$this->SetFont('', '', 9);	    	
	    	$this->Cell(45, 5, $equipamento->tipo_equipamento->nome, 'TBR', 0, 'C', 0);	
	    	$this->SetFont('', 'B', 9);
	    	$this->Cell(15, 5, "Fornecedor:", 'LTB', 0, 'L', 0);
	    	$this->SetFont('', '', 9);		    	
	    	$this->Cell(45, 5, $equipamento->fornecedor, 'TBR', 0, 'C', 0);	
	    	$this->SetFont('', 'B', 9);
	    	$this->Cell(15, 5, "Modelo:", 'LTB', 0, 'L', 0);	
	    	$this->SetFont('', '', 9);	    	
	    	$this->Cell(45, 5, $equipamento->modelo, 'TBR', 0, 'C', 0);	
			
			$this->Ln();

			$this->SetFont('', 'B', 9);
	    	$this->Cell(30, 5, "Período dos alertas:", 'LTB', 0, 'L', 0);
	    	$this->SetFont('', '', 9);
	    	$this->Cell(150, 5, date('d/m/Y', strtotime($dataInicio))." à ".date('d/m/Y', strtotime($dataFim)), 'TBR', 0, 'C', 0);
	    	$this->Ln();
